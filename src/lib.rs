// src/lib.rs
/*
 * Core library for VolumeAnalyzer
 */
...
#[derive(Debug)]
pub struct VolumeAnalyzerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VolumeAnalyzerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VolumeAnalyzer processing");
    
    let mut processor = VolumeAnalyzerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VolumeAnalyzerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VolumeAnalyzerProcessor::new(false);
